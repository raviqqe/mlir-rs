...
impl TypeState {
    ...
    fn parameters_without(fields: &[String], field: &str) -> impl Iterator<Item = GenericArgument> {
    ...
    fn arguments_with_all(fields: &[String], set: bool) -> impl Iterator<Item = GenericArgument> {
